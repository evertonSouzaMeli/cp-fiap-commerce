...
SELECT * FROM TB_CART cart JOIN TB_CART_PRODUCT cart_product ON cart.ID = cart_product.CART_ID JOIN TB_PRODUCT product ON product.ID = cart_product.PRODUCT_ID;